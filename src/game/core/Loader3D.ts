...
import type {Animations} from "../../types/Animations.ts";
...
export default class Loader3D {
    ...
    public static async loadMeshGltfWithAnimations(url: string): Promise<{
    ...
    public static async loadMeshFbxWithAnimations(url: string): Promise<{
        model: Three.Object3D;
        animations: Animations
    }> {
